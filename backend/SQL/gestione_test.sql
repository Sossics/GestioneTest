...
ALTER TABLE `domanda` ADD `punti` DOUBLE NULL DEFAULT '0.0' AFTER `test_id`;
ALTER TABLE `sessione` ADD `svolgibile` BOOLEAN NOT NULL DEFAULT FALSE AFTER `data_fine`;
ALTER TABLE `risposta` DROP INDEX `fk_risposta_tentativo`;
ALTER TABLE gestione_test.risposta DROP FOREIGN KEY fk_risposta_tentativo;
ALTER TABLE `tentativo` CHANGE `id` `id` VARCHAR(100) NOT NULL;
ALTER TABLE `risposta` CHANGE `tentativo_id` `tentativo_id` VARCHAR(100) NOT NULL;
